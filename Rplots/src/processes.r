...
end_max = as.numeric(as.POSIXct("2017-03-16 13:00:00 CET"))
#start_max = as.numeric(as.POSIXct("2017-03-16 13:30:00 CET"))
#end_max = as.numeric(as.POSIXct("2017-02-08 16:30:00 CET"))
start = start_max
end = end_max
